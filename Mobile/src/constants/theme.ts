...
export const darkColors = {
  // Primary Brand Colors
  primary: '#F27125', // Cam FPT (giữ nguyên hoặc chỉnh nhẹ)
  primarySoft: 'rgba(242, 113, 37, 0.15)',
  primaryActive: 'rgba(242, 113, 37, 0.25)',
  primaryGradientStart: '#F27125',
  primaryGradientEnd: '#FFC371',

  // Backgrounds
  background: '#18191A', // Nền ứng dụng tối
  card: '#242526',       // Nền thẻ tối

  // Text Colors
  textMain: '#E4E6EB',   // Trắng ngà
  textMuted: '#B0B3B8',  // Xám sáng
  textLight: '#8A8D91',  // Xám tối hơn
